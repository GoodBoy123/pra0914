...
public class CategoryFController {
    ...
    public void loadBaseData() {
        mCategoryPage = 1;
        GankController.getSpecifyGanHuo(BaseApplication.getUserId() , mCategoryType, 1, new RetrofitListener<List<DevelopmentDto>>() {
            @Override
            public void onSuccess(List<DevelopmentDto> data) {
    ...
    public void startPullUpRefresh() {
        ...
        GankController.getSpecifyGanHuo(BaseApplication.getUserId(),mCategoryType, ++mCategoryPage, new RetrofitListener<List<DevelopmentDto>>() {
            @Override
            public void onSuccess(List<DevelopmentDto> data) {
